...
<head>
    ...
    <title>Daftar ke Kedai Cendana</title>
...
<body>
    <div class="row vh-100 g-0">
        ...
        <div class="col-lg-6 position-relative d-none d-lg-block">
            <img src="{{ asset('images/image2.webp') }}" alt="Login Background"
            ...
            <div class="row align-items-center justify-content-center h-100 g-0 px-4 px-sm-0">
                <div class="col col-sm-6 col-lg-7 col-xl-6">
                    ...
                    <a class="d-flex justify-content-center mb-4">
                        <img src="{{ asset('images/logo_cendana.webp') }}" alt="Kedai Cendana" width="80"
                            draggable="false">
                    </a>
                    <!-- Logo -->
                    ...
                    <div class="text-center mb-5">
                        <h3>Daftar</h3>
                        <p class="text-secondary">Buat Akun Anda</p>
                    </div>

                    <!-- Daftar Google -->
                    <a href="{{ url('auth/redirect') }}"
                        class="btn btn-lg btn-outline-custom w-100 d-flex align-items-center justify-content-center">
                        <img src="{{ asset('images/google_logo.webp') }}" alt="Google" width="20" class="me-2"
                            draggable="false">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="input-group mb-3">
                            <input type="text"
                                class="form-control form-control-lg fs-6 @error('nama_user') is-invalid @enderror"
                                placeholder="Nama Pengguna" name="nama_user" value="{{ old('nama_user') }}" required>
                            @error('nama_user')
                    ...
                    <div class="text-center">
                        <small class="text-secondary">Sudah punya akun? <a href="{{ route('login') }}"
                                class="biru">Login</a></small>
                    </div>
                </div>
            </div>
        </div>
