...
<head>
    ...
    <title>Kedai Cendana - Lupa Password</title>
            ...
            <div class="row align-items-center justify-content-center h-100 g-0 px-4 px-sm-0">
                <div class="col col-sm-6 col-lg-7 col-xl-6">
                    ...
                    @else
                        ...
                        <p class="text-center text-secondary mb-4">Masukkan email Anda untuk menerima tautan reset
                            password.</p>
                        ...
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <button type="submit" class="btn btn-primary btn-cendana btn-lg w-100">Kirim Tautan Reset
                                Password</button>
                        </form>
                    @endif
                </div>
