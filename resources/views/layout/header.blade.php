  ...
  <div class="container">
      ...
      <div class="offcanvas-body">
        ...
        <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
          ...
          <li class="nav-item d-lg-none">
            <a class="nav-link py-2" href="#"><i class="bi bi-person me-2"></i>Profil Saya</a>
          </li>
          <li class="nav-item d-lg-none">
            <a class="nav-link py-2" href="{{ route('history.index') }}"><i class="bi bi-bag-check me-2"></i>Pesanan</a>
          </li>
          ...
          <li class="nav-item d-lg-none mt-4">
            <a href="{{ route('login') }}" class="btn btn-primary w-100 py-2 rounded-3 text-white">Login Sekarang</a>
          </li>
          @endguest
        </ul>
      </div>
    ...
    <div class="header-actions ms-lg-auto d-flex align-items-center">
      ...
      <div class="dropdown d-none d-lg-block">
        <a href="#" class="login-button dropdown-toggle shadow-sm" data-bs-toggle="dropdown" aria-expanded="false">
          Profil
        </a>
        <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 mt-3 rounded-4 animate slideIn">
          ...
          <li><a class="dropdown-item py-2 px-4 mt-2" href="#"><i class="bi bi-person me-2"></i>Akun Saya</a></li>
      ...
      <!-- Toggler Mobile -->
      <button class="navbar-toggler pe-0 ms-2 border-0 shadow-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar">
