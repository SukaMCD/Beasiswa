...
<head>
    ...
    <title>Kedai Cendana - Kesalahan Server</title>
    ...
    <style>
        ...
        .blob {
            ...
            width: 500px;
            height: 500px;
            background: radial-gradient(circle, rgba(100, 116, 139, 0.08) 0%, rgba(255, 255, 255, 0) 70%);
            border-radius: 50%;
            z-index: -1;
            filter: blur(50px);
        }
...
<body>
    ...
    <div class="error-wrapper">
        ...
        <p class="error-desc">Mesin kami sedang kewalahan melayani pesanan. Kami akan segera kembali, mohon tunggu
            sebentar.</p>
