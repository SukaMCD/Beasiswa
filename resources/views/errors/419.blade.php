...
<head>
    ...
    <title>Kedai Cendana - Sesi Berakhir</title>
    ...
    <style>
        ...
        .blob {
            ...
            width: 500px;
            height: 500px;
            background: radial-gradient(circle, rgba(241, 196, 15, 0.08) 0%, rgba(255, 255, 255, 0) 70%);
            border-radius: 50%;
            z-index: -1;
            filter: blur(50px);
        }
...
<body>
    ...
    <div class="error-wrapper">
        ...
        <p class="error-desc">Maaf, sesi Anda sudah basi seperti kopi lama. Silakan segarkan halaman untuk memesan yang
            baru.</p>
