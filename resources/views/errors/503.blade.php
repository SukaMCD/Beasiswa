...
<head>
    ...
    <title>Kedai Cendana - Sedang Pemeliharaan</title>
...
<body>
    ...
    <div class="error-wrapper">
        ...
        <p class="error-desc">Kami sedang meracik sesuatu yang baru untuk Anda. Kedai akan segera dibuka kembali dalam
            waktu singkat.</p>
        <button onclick="window.location.reload()" class="btn-action">
            <i class="bi bi-arrow-repeat me-2"></i>Segarkan Halaman
        </button>
    </div>
</body>
